...
GO
PRINT N'Rename refactoring operation with key 1d862b8e-d2c1-4011-a42f-668e6faba795 is skipped, element [dbo].[Dim_Tempo].[C] (SqlSimpleColumn) will not be renamed to Nome_Semestre';


GO
PRINT N'Rename refactoring operation with key f587fd01-67d2-40f5-9d3a-f72ff6a5c0bb is skipped, element [dbo].[Dim_Tempo].[E_Dia_Semana] (SqlSimpleColumn) will not be renamed to Tipo_Dia';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1d862b8e-d2c1-4011-a42f-668e6faba795')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1d862b8e-d2c1-4011-a42f-668e6faba795')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'f587fd01-67d2-40f5-9d3a-f72ff6a5c0bb')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('f587fd01-67d2-40f5-9d3a-f72ff6a5c0bb')
